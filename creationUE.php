            ...
            <div class="col-sm-5">
              ...
              <form action="resCreerUE.php" method = GET>
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="nomUE" placeholder="Nom de l'U.E." name="intituleUE" value='<?php echo $intituleUE ?>'>
                  </div>
                  <div class="form-group"> 
                    <label for="sel1">Formation :</label>
                    <select class="form-control" id="sel1" name="formationUE" value="">
                      <option>Choisir une formation </option>
                          <?php             
                              for($i=0;$i<=count($resFormation)-1;$i++){
                          ?>
                      <Option <?php if ($idf==$resFormation[$i]['IdF']){ echo "selected";}?> value ="<?php echo $resFormation[$i]['IdF'] ?>"><?php echo $resFormation[$i]['IntituleF'] ?></option>     
                          <?php
                              }
                          ?>
                      
                    </select>
                    <input type='hidden' value='<?php echo $idue ?>' name='idue'></input>
                  </div> 
